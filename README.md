...
## Sprites from the Universal LPC Spritesheet Generator
...
- Detailed credits: https://github.com/morenopilaralejandro/Simulation/blob/master/Credits/
...
This project is dual-licensed under **GNU GPL v3** and **CC BY-SA 4.0**. See the [LICENSE](LICENSE.txt) file for details.
