...
{
    private const string OutputPath = "Assets/Localization/Generated/FontAtlas/FontAtlasCharacters.txt";
    ...
    /// </summary>
    [MenuItem("Tools/Localization/Generate Font Atlas")]
    public static void GenerateFontAtlas()
    {
        ...
        Debug.Log($"[FontAtlasGenerator] Wrote {sortedCharacters.Count} unique characters to {OutputPath}");
