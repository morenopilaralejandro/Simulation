...
public class StorySystemManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        chaptersSystem = new StorySystemChapters();
    ...
    // flagSystem
    public IReadOnlyDictionaryDictionary<string, bool> FlagsDict => flagSystem.FlagsDict;
    ...
    // chapterSystem
    public StoryChapters CurrentChapter => chapterSystem.CurrentChapter;
