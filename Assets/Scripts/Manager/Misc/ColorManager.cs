...
public static class ColorManager
{
    ...
    private static readonly Dictionary<WingColorType, Color> wingColors =
        new Dictionary<WingColorType, Color>()
    {
        { WingColorType.Amber,         new Color(0xFB/255f, 0xE7/255f, 0xA4/255f, 1f) },
        { WingColorType.Ash,           new Color(0xFF/255f, 0xF1/255f, 0xC1/255f, 1f) },
        { WingColorType.Black,         new Color(0x4A/255f, 0x50/255f, 0x57/255f, 1f) },
        { WingColorType.Blonde,        new Color(0xFC/255f, 0xCF/255f, 0x56/255f, 1f) },
        { WingColorType.Blue,          new Color(0x1E/255f, 0x85/255f, 0xEF/255f, 1f) },
        { WingColorType.Bluegray,      new Color(0x79/255f, 0x97/255f, 0x9D/255f, 1f) },
        { WingColorType.Bright_Green,  new Color(0x99/255f, 0xD2/255f, 0x48/255f, 1f) },
        { WingColorType.Bronze,        new Color(0xD3/255f, 0x8B/255f, 0x59/255f, 1f) },
        { WingColorType.Brown,         new Color(0x9C/255f, 0x66/255f, 0x3E/255f, 1f) },
        { WingColorType.Carrot,        new Color(0xFF/255f, 0xB3/255f, 0x9C/255f, 1f) },
        { WingColorType.Ceramic,       new Color(0x7D/255f, 0x60/255f, 0x4D/255f, 1f) },
        { WingColorType.Chestnut,      new Color(0xD2/255f, 0x81/255f, 0x02/255f, 1f) },
        { WingColorType.Dark_Brown,    new Color(0x79/255f, 0x28/255f, 0x06/255f, 1f) },
        { WingColorType.Dark_Gray,     new Color(0x7C/255f, 0x7C/255f, 0x7C/255f, 1f) },
        { WingColorType.Dark_Green,    new Color(0x50/255f, 0x9E/255f, 0x59/255f, 1f) },
        { WingColorType.Dragonfly,     new Color(0x83/255f, 0xE5/255f, 0xF7/255f, 1f) },
        { WingColorType.Forest,        new Color(0x1B/255f, 0x55/255f, 0x02/255f, 1f) },

        { WingColorType.Fur_Black,     new Color(0x15/255f, 0x42/255f, 0x59/255f, 1f) },
        { WingColorType.Fur_Brown,     new Color(0x62/255f, 0x41/255f, 0x35/255f, 1f) },
        { WingColorType.Fur_Copper,    new Color(0xCC/255f, 0x69/255f, 0x01/255f, 1f) },
        { WingColorType.Fur_Gold,      new Color(0xFC/255f, 0xCF/255f, 0x56/255f, 1f) },
        { WingColorType.Fur_Grey,      new Color(0x90/255f, 0x96/255f, 0x99/255f, 1f) },
        { WingColorType.Fur_Tan,       new Color(0xB8/255f, 0x87/255f, 0x51/255f, 1f) },
        { WingColorType.Fur_White,     new Color(0xB8/255f, 0xBB/255f, 0xBC/255f, 1f) },

        { WingColorType.Ginger,        new Color(0xFA/255f, 0xA3/255f, 0x01/255f, 1f) },
        { WingColorType.Gold,          new Color(0xFF/255f, 0xE4/255f, 0x53/255f, 1f) },
        { WingColorType.Gray,          new Color(0xD9/255f, 0xD9/255f, 0xD9/255f, 1f) },
        { WingColorType.Green,         new Color(0x00/255f, 0xA7/255f, 0x00/255f, 1f) },
        { WingColorType.Iron,          new Color(0x34/255f, 0x30/255f, 0x43/255f, 1f) },
        { WingColorType.Lavender,      new Color(0xFB/255f, 0xEC/255f, 0xE6/255f, 1f) },
        { WingColorType.Light,         new Color(0xFA/255f, 0xEC/255f, 0xE7/255f, 1f) },
        { WingColorType.Light_Brown,   new Color(0xC8/255f, 0x8D/255f, 0x58/255f, 1f) },
        { WingColorType.Lunar,         new Color(0xAB/255f, 0xEA/255f, 0xA9/255f, 1f) },
        { WingColorType.Maroon,        new Color(0xAE/255f, 0x42/255f, 0x4A/255f, 1f) },
        { WingColorType.Monarch,       new Color(0xE6/255f, 0x91/255f, 0x10/255f, 1f) },
        { WingColorType.Navy,          new Color(0x46/255f, 0x6A/255f, 0xC9/255f, 1f) },
        { WingColorType.Olive,         new Color(0xE4/255f, 0xA4/255f, 0x7C/255f, 1f) },
        { WingColorType.Orange,        new Color(0xE5/255f, 0x56/255f, 0x00/255f, 1f) },
        { WingColorType.Pale_Green,    new Color(0xAD/255f, 0xCC/255f, 0xA6/255f, 1f) },
        { WingColorType.Pink,          new Color(0xEA/255f, 0x95/255f, 0xD5/255f, 1f) },
        { WingColorType.Pixie,         new Color(0x25/255f, 0xD3/255f, 0xF3/255f, 1f) },
        { WingColorType.Platinum,      new Color(0xF6/255f, 0xF6/255f, 0xF3/255f, 1f) },
        { WingColorType.Purple,        new Color(0xA9/255f, 0x66/255f, 0xDD/255f, 1f) },
        { WingColorType.Raven,         new Color(0x1A/255f, 0x53/255f, 0x69/255f, 1f) },
        { WingColorType.Red,           new Color(0xF1/255f, 0x58/255f, 0x3A/255f, 1f) },
        { WingColorType.Redhead,       new Color(0xE7/255f, 0x47/255f, 0x16/255f, 1f) },
        { WingColorType.Rose,          new Color(0xFA/255f, 0xE1/255f, 0xE5/255f, 1f) },
        { WingColorType.Sandy,         new Color(0xF6/255f, 0xF6/255f, 0xC2/255f, 1f) },
        { WingColorType.Silver,        new Color(0x81/255f, 0x8B/255f, 0x8B/255f, 1f) },
        { WingColorType.Sky,           new Color(0xB9/255f, 0xE3/255f, 0xF7/255f, 1f) },
        { WingColorType.Strawberry,    new Color(0xF6/255f, 0xF6/255f, 0xC2/255f, 1f) },
        { WingColorType.Taupe,         new Color(0xC7/255f, 0x93/255f, 0x5F/255f, 1f) },
        { WingColorType.Teal,          new Color(0x2D/255f, 0xAC/255f, 0xD9/255f, 1f) },
        { WingColorType.Violet,        new Color(0x57/255f, 0x92/255f, 0xF2/255f, 1f) },
        { WingColorType.White,         Color.white },
        { WingColorType.Yellow,        new Color(0xF3/255f, 0xC0/255f, 0x3F/255f, 1f) },
        { WingColorType.Zombie_Green,  new Color(0xF2/255f, 0xF0/255f, 0xC4/255f, 1f) }
    };

    public static Color GetWingColor(WingColorType wingColorType)
    {
        return wingColors.TryGetValue(wingColorType, out var color)
            ? color
            : Color.white;
    }
