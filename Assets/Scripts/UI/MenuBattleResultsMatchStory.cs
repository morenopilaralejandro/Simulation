...
public class MenuBattleResultsMatchStory : Menu
{
    #region Fields
    ...
    */
    ...
    {
        base.OnEnable();
        UIEvents.OnResultsMatchStoryOpenRequested += HandleResultsMatchStoryOpenRequested;
    }
    ...
    private void HandleResultsMatchStoryOpenRequested(BattleResultData data)
    {
        this.data = data;
