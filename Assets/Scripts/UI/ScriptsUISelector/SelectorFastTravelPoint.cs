...
public class SelectorFastTravelPoint : Selector<FastTravelPoint, SelectorFastTravelPointListItem>
{
    #region Fields
    ...
    protected override void Bind(SelectorFastTravelPointListItem view, FastTravelPoint data)
    {
        // Other code here
        view.Bind(data);
    }
    ...
    */
    ...
    {
        base.OnEnable();
        UIEvents.OnFastTravelPointSelectorOpenRequested += HandleOpenRequested;
    ...
    private void HandleOpenRequested(
        ...
        ISelectorFilter<FastTravelPoint>      filter)
    {
