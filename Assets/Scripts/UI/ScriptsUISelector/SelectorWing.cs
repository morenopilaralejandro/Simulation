...
public class SelectorWing : Selector<Wing, SelectorWingListItem>
{
    #region Fields
    ...
    */
    ...
    protected override void Bind(SelectorWingListItem view, Wing data)
    {
    ...
    */
    ...
    {
        base.OnEnable();
        UIEvents.OnWingSelectorOpenRequested += HandleOpenRequested;
    }
